...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Agro-Commer</a>
        ...
        <section class="page-section" id="contact">
            ...
            <div class="my-class">
        <select id="searchby">
            <option selected hidden>Searh By</option>
            <option value="nid">nid</option>
            <option value="notice">Notice</option>
        </select>
        <input type="text" name="search" id="search" placeholder="Search Notice">
    </div>
        ...
        <% 
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/home/edit/<%= std.nid %>/<%= std.notice %>">Edit</a> |
                    <a href="/home/delete/<%= std.nid %>/<%= std.notice %>">Delete</a>
                </td>
            </tr>
        <%
            }); 
    ...
    <div class="my-class">
        <a href="/home/create" class="center">New Notice</a>
        </div>
        </section>
        <!-- Footer-->
